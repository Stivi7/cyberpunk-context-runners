...
=======
- For each agent specify the ai model that will be used. for example fixer and nexus gpt sol. If the model is not found, it falls to inherit (since it depends on the ai tool being used)
>>>>>>> Stashed changes
